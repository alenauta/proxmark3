...
const QMetaObjectExtraData ProxWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ProxWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ProxWidget,
      qt_meta_data_ProxWidget, &staticMetaObjectExtraData }
};
...
void ProxGuiQT::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        ProxGuiQT *_t = static_cast<ProxGuiQT *>(_o);
        switch (_id) {
        case 0: _t->ShowGraphWindowSignal(); break;
        case 1: _t->RepaintGraphWindowSignal(); break;
        case 2: _t->HideGraphWindowSignal(); break;
        case 3: _t->_ShowGraphWindow(); break;
        case 4: _t->_RepaintGraphWindow(); break;
        case 5: _t->_HideGraphWindow(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData ProxGuiQT::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ProxGuiQT::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ProxGuiQT,
      qt_meta_data_ProxGuiQT, &staticMetaObjectExtraData }
};
